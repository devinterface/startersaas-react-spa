    ...
    <div className="max-width">
          ...
          <Modal.Body>
            ...
            <div className="mt-4">
              ...
              <Form.Control
                ...
                value={newTeam.code}
                onChange={(event) =>
                  setNewTeam({ ...newTeam, code: event.target.value })
                }
              />
            </div>
          </Modal.Body>
      ...
      <Modal show={deleteModal} centered onHide={() => setDeleteModal(false)}>
        <ModalHeader closeButton>
          <h4 className="text-center w-100-perc">
      ...
      <div className="dashboard-box mt-5 h-auto">
        <div className="d-flex justify-content-end mb-4">
          <div
            className="mt-3 create-group-button d-flex justify-content-center align-items-center"
            onClick={() => {
            ...
            {teams && (
              <>
                {teams.data.map((element, i) => (
                  <tr
                    key={`team-${i}`}
                    className="text-secondary d-flex flex-column d-md-table-row"
                  >
                    ...
                    <td className="text-start border-0 text-break d-flex justify-content-start">
                      <Link
                        to={`/teams/${element.id}`}
                        className="me-2 group-button-edit text-decoration-none"
                      >
                        {t("teamsPage.edit")}
                      </Link>
                      <div
                        ...
                        className="me-2 group-button-delete text-decoration-none"
                      >
                        {t("teamsPage.delete")}
                      </div>
                    </td>
