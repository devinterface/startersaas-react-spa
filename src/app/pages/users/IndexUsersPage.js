      ...
      <div>
          ...
          <div className="popup-crea-gruppo p-4">
            <div>
              ...
              <input
                ...
                type={"text"}
                className="w-100-perc popup-crea-gruppo-input"
                placeholder="..."
              />
            </div>
            <div>
        ...
        <div className="dashboard-box mt-3 h-auto">
          ...
          <Table responsive>
            <thead>
              <tr>
                <th className="col-1 text-center fs-4">
                  {t("indexUsersPage.name")}
                </th>
                <th className="col-1 text-center fs-4">
                  {t("indexUsersPage.surname")}
                </th>
                <th className="col-1 text-center fs-4" id="code-group">
                  {t("indexUsersPage.email")}
                </th>
                <th className="col-1 text-center fs-4" id="delete-group">
