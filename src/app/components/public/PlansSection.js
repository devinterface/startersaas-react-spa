        ...
        <div className='text-center'>
          <div className='row d-flex d-sm-flex d-lg-flex flex-column align-items-center flex-lg-row justify-content-lg-center mb-4'>
            <div className='col-sm-11 col-md-10 col-lg-8 col-xl-6'>
              ...
              <p>Il nostro servizio è semplice, efficace ed economico. Scegli tra due piani: quello Base è pensato per le piccole aziende, negozi e attività che hanno bisogno di crescere. Quello Pro è adatto alle medie e grandi imprese che vogliono avere una presenza online importante.</p>
            </div>
          </div>
          ...
          <div className='row d-flex d-sm-flex d-lg-flex flex-column align-items-center flex-lg-row justify-content-lg-center'>
            <div className='col-sm-11 col-md-8 col-lg-6 col-xl-5 mb-3'>
              ...
              <p>I pacchetti sono rinnovabili mensilmente, disdici il servizio quando vuoi senza costi aggiuntivi.</p>
            </div>
          </div>
        </div>
      </div>
