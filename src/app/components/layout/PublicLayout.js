                  ...
                  >
                    <ul className="navbar-nav d-md-flex flex-grow-1 justify-content-md-end flex-lg-grow-0 justify-content-xl-end">
                      <li className="nav-item">
                        <a className="nav-link active" href="#vantaggi">
                          Vantaggi
                        </a>
                      </li>
                      <li className="nav-item">
                        <a className="nav-link active" href="#prezzi">
                          Prezzi
                        </a>
                      </li>
                      <li className="nav-item">
                        <a className="nav-link active" href="#chi-siamo">
                          Chi siamo
                        </a>
                      </li>
                      <li className="nav-item">
                        <a className="nav-link active" href="#servizi">
                          Servizi
                        </a>
                      </li>
                      <li className="nav-item">
                        <a className="nav-link active" href="#contatti">
                          Contattaci
                        </a>
                      </li>
                      <li className="nav-item">
