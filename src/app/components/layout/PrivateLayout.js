                ...
                <Container fluid>
                      ...
                      <a className="navbar-brand" onClick={goToHome}>
                        <picture>
                          <source
                            ...
                            srcSet="/images/startersaas180x180.png"
                          />
                          <img
                            className="logo-mediaq w-md-auto ms-2 "
                    ...
                    <ul className="navbar-nav d-flex flex-row justify-content-center d-md-flex justify-content-md-end flex-lg-grow-0 justify-content-xl-end">
                      <li className=" me-md-4 m-auto">
                        ...
                        >
                          <FontAwesomeIcon
                            icon={faHouse}
                            className="me-0 me-md-3 fs-4 dashboard-icon"
                          />
                      ...
                      <li className="me-4 m-auto" ref={refUser}>
                        ...
                        />
                        <div
                          className={`${userIcon} usericon-drop position-absolute`}
                          ref={refUser}
                        >
                          <div className="usericon-items fw-bold">
                            {user.name}
                          </div>
                          ...
                          {user.role === "admin" && (
                            <div className="usericon-items">
                              <Link to={"/plan"} className="user-menu">
                  ...
                  >
                    ...
                    <Offcanvas.Body>
                      <Nav className="">
                        <div
                          className={`d-flex  flex-column justify-content-lg-start  gap-5 m-0-auto`}
                        >
        ...
        <div className="d-flex flex-column flex-md-row h-100">
          <div className="d-none d-md-flex flex-column justify-content-lg-start ps-5 gap-2 p-3 align-items-start text-white bg-dark mediaq-side ">
            ...
            <div className="d-flex align-items-center fs-4 ms-5 mt-0 mt-md-5">
              <>
                <Link className="text-decoration-none text-white" to="/teams">
                  {" "}
            ...
            <div className="d-flex align-items-center fs-4 ms-5 mt-0 mt-md-5">
              <>
                <Link className="text-decoration-none text-white" to={"/plan"}>
                  {" "}
