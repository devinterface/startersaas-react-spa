export default {
  ...
  stripeCCForm: {
    ...
    addCardFailed: 'La carta di credito non è stata aggiunta a causa di questi errori:'
  },
  planCard: {
  ...
  trialComponent: {
    youAreOnTrial: 'Stai attualmente utilizzando la versione di prova di Starter SaaS.',
